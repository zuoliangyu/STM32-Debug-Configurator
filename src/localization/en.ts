...
export const en: LocalizedStrings = {
    ...
    cardProject: "Project",
    cardDevice: "Target Device",
    cardGdbServer: "GDB Server",
    cardToolchain: "ARM Toolchain",
    cardAdvanced: "Advanced",
    executable: "Executable (.elf / .axf / .bin / .hex)",
    executablePlaceholder: "${workspaceFolder}/build/Debug/project.elf",
    executablePickHint: "— pick a firmware file —",
    executableDetectedHint: "Detected {0} firmware file(s); using {1}",
    cfgPickerSearch: "Type to filter…",
    cfgPickerEmpty: "No matches",
    cfgPickerNoOptions: "Provide a valid OpenOCD path first to load cfg files",
